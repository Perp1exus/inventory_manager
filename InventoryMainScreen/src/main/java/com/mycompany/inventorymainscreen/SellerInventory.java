...
public class SellerInventory  extends JFrame {
    ...
    public SellerInventory(){
        setTitle("Seller Dashboard View");
        ...
        receiveButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String sql=("INSERT INTO tableseller(name, quantity, price)"+"VALUES(?, ?, ?)");
            ...
            System.out.println("\nAdded Successfully in Seller Database!");
            connection.close();
                ...
                System.out.println("Updated into the Seller Database!"); // Handle potential errors in a better way in your actual application
                    ...
                    JOptionPane.showMessageDialog(null, "Please select a row to Receive.");
                }
            }
        });
